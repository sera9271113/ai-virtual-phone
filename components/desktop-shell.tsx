  ...
  const handleSwipeMove = useCallback((e: React.PointerEvent) => {
    ...
    if (editMode) {
      ...
      if (tap && tap.pointerId === e.pointerId) {
        ...
        if (tdx * tdy > 100) editTapRef.current = null;
      }
              ...
              <header className="phone-status-bar">
                ...
                <div className="status-right" aria-hidden>
                  <svg viewBox="0 0 72 51" className="status-signal" fill="currentColor">
                    ...
                    <path d="M31.7,36.9c0,2.8,0,5.7,0,8.5c0,3,1.2,4.4,4.2,4.4c1,0,2,0,3,0c2.9,0,4.2,1.4,4.2,4.2c0,9,0,17.9,0,26.9c0,1.4,0,2.7,0,4.1c0,2.3-1.4,3.8-3.7,3.8c-1.3,0-2.6,0-3.9,0c-2.5-0.1-3.8-1.3-3.8-3.9C31.7,30.5,31.7,33.7,31.7,36.9z" />
                  ...
                  <svg viewBox="98 0 67 51" className="status-wifi" fill="currentColor">
                    ...
                    <path d="M131.9,27.8c5.4,0.1,9.8,2,13.6,5.5c1.1,1,1.2,2,0.1,3c-1.5,1.5-2.9,2.9-4.4,4.4c-0.7,0.7-1.2,0.6-1.8,0c-1.5-1.6-2.9-3.1-4.4-4.6c-0.7-0.8-0.5-1.3,0.2-1.9C128.4,29.8,130.1,28.5,131.9,27.8z" />
