                    ...
                    <PageShell title="自定义 CSS" onBack={() => setEditingCSS(false)}>
                        <div className="theme-section-page">
                            ...
                            <div className="flex gap-2 mt-3 items-center">
                                ...
                                <button type="button" className="flex-1" style={{ height: 36, borderRadius: 12, border: "none", background: "transparent", color: "var(--c-text-title, #1a1a1a)", fontSize: "calc(14px*var(--app-text-scale,1))", fontWeight: 500, cursor: "pointer" }} onClick={() => setCssDraft(CHAT_SESSION_CSS_EXAMPLE)}>示例</button>
                                <button type="button" className="flex-1" style={{ height: 36, borderRadius: 12, border: "none", background: "transparent", color: "var(--c-text-title, #1a1a1a)", fontSize: "calc(14px*var(--app-text-scale,1))", fontWeight: 500, cursor: "pointer" }} onClick={() => setCssDraft("")}>清除</button>
                                <button type="button" className="flex-1" style={{ height: 36, borderRadius: 12, border: "none", background: "#222", color: "#fff", fontSize: "calc(14px*var(--app-text-scale,1))", fontWeight: 500, cursor: "pointer" }} onClick={() => { updateMascotSettings({ chatCustomCSS: cssDraft }); setEditingCSS(false); }}>应用</button>
                            </div>
                        </div>
                    </PageShell>
                </div>
