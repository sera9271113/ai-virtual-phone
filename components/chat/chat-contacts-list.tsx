...
export function ChatContactsList({ onSelectSession, onSelectMascot, pendingAddContactId, onPendingAddContactConsumed, onPendingAddContactBack }: ChatContactsListProps) {
        ...
        <div className="relative flex-1 h-full">
                        ...
                        <span className="relative" ref={plusMenuRef}>
                            ...
                            {showPlusMenu && (
                                <div className="g-dropdown chat-header-plus-menu absolute top-[44px] right-0 py-2 px-0 w-[140px] z-[100]">
                                    ...
                                    />
                                    <ContactMenuOption
                                        icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M5 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4c.96 0 1.84 .338 2.53 .901" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M16 19h6" /><path d="M19 16v6" /></svg>}
                                        label="创建群聊"
                                        onClick={() => {
                                            setShowPlusMenu(false);
            ...
            <div className="px-5 pt-2">
                ...
                <div className="mb-3 mt-3">
                    ...
                    >
                        <div className="w-[40px] h-[40px] rounded-full bg-[var(--c-input)] flex items-center justify-center shrink-0">
                            <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="var(--c-icon-active)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="flex-1 overflow-hidden h-[40px] flex flex-col justify-center">
                ...
                <PageShell
                    ...
                    leftAction={(
                        <button
                            ...
                            type="button"
                            onClick={() => { setIsAddFriendOpen(false); if (addFromCardRef.current) { addFromCardRef.current = false; onPendingAddContactBack?.(); } }}
                            aria-label="返回"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--c-icon)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
