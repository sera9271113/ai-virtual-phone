...
export function ChatPluginManager({ onBack }: { onBack: () => void }) {
    ...
    return (
        <PageShell title="Plugins" onBack={onBack} className="chat-plugin-page absolute inset-0 z-[100]">
            <div className="page-menu" style={{ paddingBottom: 40 }}>
                ...
                <div>
                    ...
                    <div className="chat-plugin-action-section" style={{ marginTop: 10 }}>
                ...
                {/* 运行日志 */}
                <div>
                    <div className="settings-menu-section-title">Runtime Logs</div>
                    <div className="chat-plugin-action-section" style={{ marginTop: 10 }}>
                        <button className="menu-item" onClick={() => setShowErrors(v => !v)}>
                            ...
                            <div className="menu-right chat-plugin-action-right">
                ...
                {/* 制作说明 */}
                <div>
                    <div className="settings-menu-section-title">Documentation</div>
                    <div className="chat-plugin-action-section" style={{ marginTop: 10 }}>
                        <button className="menu-item" onClick={() => setShowGuide(v => !v)}>
                            ...
                            <div className="menu-right chat-plugin-action-right">{showGuide ? <ChevronUp size={16} /> : <ChevronDown size={16} />}</div>
                        </button>
                        {showGuide && (
                            <div style={{ padding: "0 16px 16px", display: "flex", flexDirection: "column", gap: 10 }}>
