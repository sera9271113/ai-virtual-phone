...
export function ChatMessageList({ activeSession, onSelectSession, onSelectMascot }: ChatMessageListProps) {
    ...
    return (
        <div className="relative flex-1 h-full">
            <div className="page-shell chat-list-page-shell">
                ...
                <div className="page-body" data-ui="body">
            ...
            {isSearchModalOpen && (
                ...
                <PageShell
                    title="添加朋友"
                    leftAction={(
                        <button className="page-back-btn" type="button" onClick={() => setIsSearchModalOpen(false)} aria-label="返回">
            ...
            {isGroup ? (
                session.groupAvatar ? (
                    <div className="minimal-avatar-wrapper">
                        <img src={session.groupAvatar} className="w-full h-full object-cover pointer-events-none rounded-full" alt="" />
                    </div>
                ) : (
