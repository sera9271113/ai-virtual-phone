...
import { Plus, SquarePlus, Trash2, Upload, Download, Play, ChevronLeft, ChevronRight, AlertCircle, Maximize2, X, Wand } from "lucide-react";
import {
    loadRegexes,
    saveRegexes,
    createRegexGroup,
...
export function RegexManager({ isActive = true }: { isActive?: boolean } = {}) {
    ...
    // Top-right header icons — list view shows import/add, detail view shows export/delete
    useEffect(() => {
        if (viewMode === "list") {
        ...
        } else if (viewMode === "detail" && activeGroup) {
            setSubpageRightAction("regex",
                <div className="flex items-center gap-0">
                    <button
                        type="button"
                    ...
                    <button
                        ...
                        aria-label="删除正则"
                        className="grid place-items-center w-10 h-10 text-[var(--c-danger)] active:scale-[0.78] active:opacity-50 transition-all"
                        style={{ background: "none", border: "none", cursor: "pointer" }}
                    >
    ...
    }, [viewMode, activeGroup, addGroup, handleExport, setSubpageRightAction]);
                                ...
                                >
                                    <div className="min-w-0 flex flex-col gap-1.5">
                                        <div className="min-w-0 flex items-center gap-[6px]">
                                            <span className="truncate text-[calc(14.5px*var(--app-text-scale,1))] font-medium leading-tight text-[var(--c-text-title)]">{group.name}</span>
                                        </div>
                ...
                <>
                    {activeGroup && (
                        <div className="flex flex-col gap-6 pb-6">
                            ...
                            <h2 className="settings-menu-section-title mx-2">Regex Info</h2>
                            <div className="ui-entry-card" style={{ cursor: "default" }}>
                                <div className="flex flex-col gap-2">
                                    <label className="menu-label ts-13 font-medium ml-1">正则组名称</label>
                                    <input
                                        type="text"
                            ...
                            <div className="flex flex-col gap-2">
                            <h2 className="settings-menu-section-title mx-2">Regex Rules ({activeGroup.rules?.length || 0})</h2>
                                                ...
                                                <div className="flex justify-between items-start">
                                                    ...
                                                    >
                                                        <div className="flex flex-col gap-1 flex-1">
                                                            <span className="menu-label font-medium break-all ts-15">
                                                    ...
                                                    <div className="flex gap-3 ml-3 shrink-0 items-center">
                                                        ...
                                                        <button
                                                            ...
                                                            className="ui-link-btn p-1 opacity-40 hover:opacity-100"
                                                            data-variant="muted"
                                                        >
                                                            <Trash2 size={16} />
                                                        </button>
