...
export function WeixinSettings() {
    ...
    useEffect(() => {
        if (!addStep) {
            ...
            setSubpageRightAction("weixin", null);
        }
        return () => setSubpageRightAction("weixin", null);
    }, [addStep, setSubpageRightAction]);
        ...
        <div className="flex flex-col gap-[24px] h-full">
            ...
            <div className="ui-group-card !flex-row !items-center">
                <div className="flex-1 flex flex-col gap-1">
                    <span className="menu-label font-medium menu-label-lg">后台保活</span>
            ...
            <div className="ui-group-card !items-stretch">
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 flex flex-col gap-1">
                        <span className="menu-label font-medium menu-label-lg">微信本地助手</span>
                            ...
                            <div key={bot.id} className="ui-group-card !flex-row !items-center">
                                <div className="flex-1 flex flex-col gap-1">
                                    <div className="flex items-center gap-[6px]">
                                        {statusDot(bot.id)}
                                        <span className="menu-label font-medium menu-label-lg">{char?.name ?? bot.nickname ?? bot.characterId}</span>
                                    </div>
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                    <button
                                        ...
                                        title="同步本地助手运行包"
                                    >
                                        {cloudSyncingId === bot.id ? <Loader2 size={16} className="animate-spin" /> : <CloudUpload size={16} />}
                                    </button>
                                    <button
                                        type="button"
                ...
                >
                    ...
                    {addStep === "scanning" && (
                        <div className="flex flex-col items-center gap-3">
                            <span className="menu-label font-medium menu-label-lg">{characters.find(c => c.id === newCharacterId)?.name}</span>
