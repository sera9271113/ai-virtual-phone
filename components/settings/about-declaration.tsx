    ...
    return (
        <div className="flex flex-col gap-5 h-full">
            <div className="flex flex-col gap-2">
                <p className="settings-menu-section-title mx-2">Disclaimer</p>

                <div className="g-card">
                    <div className="flex items-start gap-3">
                        <ShieldAlert size={20} className="shrink-0 mt-0.5 text-[var(--c-warning)]" />
                        <div className="flex flex-col gap-2">
                            <span className="menu-label-lg font-medium">AI 生成内容声明</span>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-2">
                            <span className="menu-label-lg font-medium">隐私与数据安全</span>
                            <span className="menu-desc ts-13 leading-relaxed !mt-0">
            ...
            <div className="flex flex-col gap-2">
                <p className="settings-menu-section-title mx-2">Related</p>
