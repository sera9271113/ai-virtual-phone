...
import { Plus, SquarePlus, BookOpen, Trash2, Upload, Download, ChevronLeft, ChevronRight, AlertCircle, Maximize2 } from "lucide-react";
import {
    loadWorldBooks,
    saveWorldBooks,
    createWorldBook,
...
export function WorldBookManager({ isActive = true }: { isActive?: boolean } = {}) {
    ...
    useEffect(() => {
        ...
        } else if (viewMode === "detail" && activeBook) {
            setSubpageRightAction("worldbook",
                <div className="flex items-center gap-0">
                    <button
                        type="button"
    ...
    }, [viewMode, activeBook, addBook, handleExport, setSubpageRightAction]);
                                ...
                                >
                                    <div className="min-w-0 flex flex-col gap-1.5">
                                        <div className="min-w-0 flex items-center gap-[6px]">
                                            <span className="truncate text-[calc(14.5px*var(--app-text-scale,1))] font-medium leading-tight text-[var(--c-text-title)]">{book.name}</span>
                                        </div>
                ...
                <>
                    ...
                    {activeBook && (
                        <div className="flex flex-col gap-6 pb-6">
                            ...
                            <h2 className="settings-menu-section-title mx-2">Worldbook Info</h2>
                            <div className="ui-entry-card" style={{ cursor: "default" }}>
                                <div className="flex flex-col gap-2">
                                    <label className="menu-label ts-13 font-medium ml-1">世界书名称</label>
                                    <input
                                        type="text"
                            ...
                            {/* Entries Section */}
                            <div className="flex flex-col gap-2">
                            <h2 className="settings-menu-section-title mx-2">Worldbook Entries ({activeBook.entries?.length || 0})</h2>
