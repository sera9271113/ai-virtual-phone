            ...
            <div className="mem-tl mem-tl-cards">
                {clusters.map((cluster) => {
                    ...
                    return (
                        ...
                        >
                            <span className="ts-10 font-bold uppercase" style={{
                                color: "#B0B0B0", background: "#FBFBFB", opacity: 0.9, position: "absolute", right: 12, top: 12,
                                padding: "3px 8px", borderRadius: 6, letterSpacing: "0.4px"
                            }}>REPORT</span>
                            <div className="flex justify-between items-center pb-2 mb-2" style={{ borderBottom: "1px solid #FBFBFB" }}>
                                <span className="ts-11 text-secondary" style={{ letterSpacing: "0.2px" }}>{formatClusterDate(cluster)}</span>
                            </div>
