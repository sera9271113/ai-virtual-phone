        ...
        <div className="music-settings">
            ...
            <div className="music-settings-body">
                ...
                <div className="music-settings-actions">
                    ...
                    <button style={{ flex: 1, height: 36, borderRadius: 12, border: "none", background: "transparent", color: "var(--c-music-text, #e0d8f0)", fontSize: "calc(11px*var(--app-text-scale,1))", fontWeight: 500, cursor: "pointer", fontFamily: "inherit" }} onClick={() => setCss(MUSIC_CSS_EXAMPLE)}>示例</button>
                    <button style={{ flex: 1, height: 36, borderRadius: 12, border: "none", background: "transparent", color: "var(--c-music-text, #e0d8f0)", fontSize: "calc(11px*var(--app-text-scale,1))", fontWeight: 500, cursor: "pointer", fontFamily: "inherit" }} onClick={() => setCss("")}>清空</button>
                    <button style={{ flex: 1, height: 36, borderRadius: 12, border: "none", background: "#222", color: "#fff", fontSize: "calc(11px*var(--app-text-scale,1))", fontWeight: 500, cursor: "pointer", fontFamily: "inherit" }} onClick={handleSave}>保存</button>
                </div>
            </div>
        </div>
    );
