...
export const STORY_CSS_EXAMPLE = `/* Story App — 全局颜色变量
   在 .story-app-shell 上声明，所有子容器通过 var() 继承 */

.story-app-shell {

  /* 文字色 */
  --c-story-text: #3B3B3B;
  --c-story-text-light: #787878;
  --c-story-heading: #2D2D2D;
  --c-story-sub: #A6A6A6;

  /* 背景色 */
  --c-story-bg: #F0F0F0;
  --c-story-bg-top: #FFFFFF;

  /* 强调色 */
  --c-story-accent: #A6A6A6;
  --c-story-accent-light: #D6D6D6;
...
/* Story App — 完整 CSS 容器索引
   按界面层级排列，每组注释说明其用途与位置 */
...
.story-top-btn {}
.story-bare-btn {}
.story-bare-btn.is-active {}


/* 侧边抽屉
   从右侧滑出的功能侧栏，包含用户信息、显示选项、工具区 */
.story-drawer-overlay {}
.story-drawer {}
.story-drawer-profile {}
.story-drawer-profile-hint {}
.story-drawer-avatar-box {}
.story-drawer-profile-meta {}
.story-drawer-meta-item {}
.story-drawer-meta-item.align-right {}
.story-drawer-meta-label {}
.story-drawer-meta-value {}
.story-drawer-body {}
.story-drawer-section {}
.story-drawer-eyebrow {}
.story-drawer-subhead {}


/* 归档信封条
   固定在顶栏下方、可横向滑动的信封列表，用于切换/新建/删除剧情存档 */
.story-archive-bar {}
.story-archive-bar.is-open {}
.story-archive-scroll {}
.story-archive-item {}
.story-archive-item.story-archive-new {}
.story-archive-item.is-active {}
.story-archive-item.is-pressing {}
.story-archive-item.is-deleting {}
.story-archive-envelope-btn {}
.story-archive-envelope-frame {}
.story-archive-envelope {}
.story-archive-envelope-left {}
.story-archive-envelope-right {}
.story-archive-envelope-pocket {}
.story-archive-envelope-flap {}
.story-archive-envelope-dashed {}
.story-archive-label {}
.story-archive-label.is-active {}
.story-archive-label-new {}
.story-archive-label-input {}


/* 删除/操作确认弹窗
   长按信封或点击消息危险操作后弹出的居中确认卡片 */
.story-archive-confirm-overlay {}
.story-archive-confirm-card {}
.story-archive-confirm-title {}
.story-archive-confirm-body {}
.story-archive-confirm-actions {}
.story-archive-confirm-actions button {}
.story-archive-confirm-actions button.danger {}


/* 主舞台滚动区
   承载所有消息列表的可滚动容器，含空状态面板和加载更多按钮 */
.story-stage {}
.story-stage-empty {}
.story-stage-inner {}
.story-load-more-btn {}
...
/* 消息行与气泡（通用气泡模式）
   传统气泡排版下的行结构、头像区、气泡容器 */
.story-row {}
.story-row[data-role="user"] {}
.story-row[data-role="assistant"] {}
.story-row[data-role="system"] {}
.story-row[data-hide-bubble="true"] {}
.story-avatar-wrap {}
.story-bubble-wrap {}
.story-bubble-head {}
.story-bubble {}
...
/* 信纸排版（Letter 模式）
   每条消息渲染为一封信纸，分为上半（问候/邮票/引文）和下半（波点底纹/正文/落款） */
.story-row-letter {}
.story-row-letter[data-hide-avatar="true"] {}
.story-row-letter[data-hide-timestamp="true"] {}
.story-row-letter[data-hide-bubble="true"] {}
.story-letter {}
.story-letter[data-role="user"] {}
.story-letter[data-role="assistant"] {}

/* 信纸：外侧消息编号标签 */
.story-letter-msg-tag {}
.story-letter-msg-tag-user {}
.story-letter-msg-tag-assistant {}

/* 信纸：顶部角落装饰点 */
.story-letter-corner-dots {}

/* 信纸：上半区域（问候语、邮票头像、引文、工具栏） */
.story-letter-top {}
.story-letter-top-content {}
.story-letter-stamp-wrap {}
.story-letter-stamp {}
.story-letter-avatar {}
.story-letter-avatar-fallback {}
.story-letter-greeting {}
.story-letter-quote {}
.story-letter-time {}
.story-letter-pinyin {}
.story-letter-toolbar {}
.story-letter-icons {}
.story-letter-icon-btn {}
.story-letter-icon-btn-danger {}

/* 信纸：下半区域（波点底纹、拍立得照片、正文、落款签名） */
.story-letter-bottom {}
.story-letter-polaroid {}
.story-letter-polaroid-caption {}
.story-letter-body {}
.story-letter-signature {}

/* 信纸：系统提示消息（无信纸外壳，居中纯文本） */
.story-letter-system {}


/* 生成中指示器
   AI 正在输出时显示的加载动画与流式文本容器 */
.story-generating-head {}
.story-generating-bubble {}
.story-generating-copy {}
.story-generating-stream-text {}
.story-generating-dots {}


/* 底部输入框
   悬浮在底部的毛玻璃输入栏，含文本域与发送/停止按钮 */
.story-composer {}
.story-send-btn {}
.story-send-btn.is-generating {}
.story-send-icon {}


/* 内联编辑
   点击编辑按钮后，消息体内原地展开的编辑区域 */
.story-inline-edit {}
.story-grow-wrap {}
.story-inline-edit-actions {}
.story-inline-edit-btn {}
.story-inline-edit-btn-save {}


/* 富文本排版
   .story-richtext 内部所有 Markdown 渲染元素的样式容器 */
.story-richtext p {}
...
/* 折叠块
   思维链（便利贴风格）与总结类（details/summary）折叠展开区块 */
.story-summary-fold {}
...
/* 旧版信息卡（已由归档信封条取代，样式保留以防自定义 CSS 仍引用）
   显示在消息列表顶部的故事简介卡片 */
.story-meta {}
.story-meta-layout {}
.story-meta-cover {}
...
/* 侧栏内角色列表与偏好设置行
   侧边抽屉内的角色切换卡片、设置行和自定义 CSS 文本框 */
.story-character-list {}
.story-character-chip {}
.story-character-chip[data-active="true"] {}
.story-pref-row {}
.story-css-box {}
`;
