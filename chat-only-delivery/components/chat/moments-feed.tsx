        ...
        >
                ...
                <div className="feed-cover-shell w-full relative mb-4">
                    ...
                    <div
                        ...
                        className="feed-cover-bg absolute inset-0 w-full h-full bg-transparent cursor-pointer z-0"
                        style={{
                    ...
                    <div
                        ...
                        style={{ paddingTop: "calc(var(--page-header-safe-top, 48px) + var(--page-header-content-height, 54px) + 80px)" }}
                    >
                        {/* Avatar */}
